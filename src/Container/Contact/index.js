...
const  ContactContainer = ()=>{
    const myData = [
        {name:'Facebook', link:'https://www.facebook.com/anirbanbabin?mibextid=ZbWKwL', text:'Follow to my facebook.'},
        // {name:'Linkedin', link:'https://www.linkedin.com/in/rohitazad/', text:'Follow to my linkedin.'},
        {name:'Twitter', link:'https://twitter.com/AnirbanMan78511', text:'Follow to my twitter.'},
        ...
        {name:'GitHub', link:'https://github.com/Anirban-ai', text:'Follow to my github account.'},
        {name:'YouTube', link:'https://www.youtube.com/@Babin-07', text:'Follow to my youtube channel.'},
